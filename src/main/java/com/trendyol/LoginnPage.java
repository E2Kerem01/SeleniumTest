...
public class LoginnPage extends BasePage1 {
    ...
    public void loginislem() throws InterruptedException {

        webelementiBekle(2);
        webElementineGönder("css", "input[type='text']", "trendyol");
        webElementiBul("css", "a[href='https://www.trendyol.com/']");
        webElementControl("En Trend Ürünler Türkiye'nin Online Alışveriş Sitesi Trendyol'da", driver.getTitle());
        webelementiBekle(2);
        ...
        webElementControl("Hesabım", driver.findElement(By.cssSelector("div[class='link account-user']>p[class='link-text']")).getText());
